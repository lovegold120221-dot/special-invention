...
const icons = {
  speaker: {
    viewBox: "0 0 16 16",
    body: `<path d="M3 5.5H5.5L9 2.5V13.5L5.5 10.5H3V5.5Z" stroke="currentColor" stroke-linejoin="round"/><path d="M11.5 6C12.2 6.7 12.5 7.5 12.5 8C12.5 8.5 12.2 9.3 11.5 10" stroke="currentColor" stroke-linecap="round"/><path d="M13 4C14.3 5.3 15 7 15 8C15 9 14.3 10.7 13 12" stroke="currentColor" stroke-linecap="round"/>`,
  },
  "speaker-muted": {
    viewBox: "0 0 16 16",
    body: `<path d="M3 5.5H5.5L9 2.5V13.5L5.5 10.5H3V5.5Z" stroke="currentColor" stroke-linejoin="round"/><path d="M12 6.5L10.5 8M10.5 6.5L12 8" stroke="currentColor" stroke-linecap="round"/>`,
  },
  edit: {
    viewBox: "0 0 16 16",
